...
Current integration version: **1.4.50**.
...
- Current manifest version: **1.4.50**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.50`, so HACS can track updates reliably.
