...
Current integration version: **1.4.56**.
...
- Current manifest version: **1.4.56**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.56`, so HACS can track updates reliably.
