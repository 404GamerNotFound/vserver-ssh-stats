...
Current integration version: **1.4.49**.
...
- Current manifest version: **1.4.49**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.49`, so HACS can track updates reliably.
