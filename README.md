...
Current integration version: **1.4.63**.
...
- Current manifest version: **1.4.63**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.63`, so HACS can track updates reliably.
