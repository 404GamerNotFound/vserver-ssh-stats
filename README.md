...
Current integration version: **1.4.57**.
...
- Current manifest version: **1.4.57**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.57`, so HACS can track updates reliably.
