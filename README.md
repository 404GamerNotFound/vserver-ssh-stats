...
Current integration version: **1.4.61**.
...
- Current manifest version: **1.4.61**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.61`, so HACS can track updates reliably.
