...
Current integration version: **1.4.58**.
...
- Current manifest version: **1.4.58**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.58`, so HACS can track updates reliably.
