...
Current integration version: **1.4.60**.
...
- Current manifest version: **1.4.60**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.60`, so HACS can track updates reliably.
