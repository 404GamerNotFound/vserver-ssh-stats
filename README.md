...
Current integration version: **1.4.66**.
...
- Current manifest version: **1.4.66**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.66`, so HACS can track updates reliably.
