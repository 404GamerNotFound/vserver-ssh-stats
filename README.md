...
Current integration version: **1.4.59**.
...
- Current manifest version: **1.4.59**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.59`, so HACS can track updates reliably.
