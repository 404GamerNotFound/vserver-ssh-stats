...
Current integration version: **1.4.64**.
...
- Current manifest version: **1.4.64**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.64`, so HACS can track updates reliably.
