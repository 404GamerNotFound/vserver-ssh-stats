...
Current integration version: **1.4.65**.
...
- Current manifest version: **1.4.65**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.65`, so HACS can track updates reliably.
