...
Current integration version: **1.4.48**.
...
- Current manifest version: **1.4.48**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.48`, so HACS can track updates reliably.
