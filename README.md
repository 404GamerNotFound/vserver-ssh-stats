...
Current integration version: **1.4.44**.
...
- Current manifest version: **1.4.44**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.44`, so HACS can track updates reliably.
