...
Current integration version: **1.4.62**.
...
- Current manifest version: **1.4.62**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.62`, so HACS can track updates reliably.
