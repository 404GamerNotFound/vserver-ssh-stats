...
Current integration version: **1.4.55**.
...
- Current manifest version: **1.4.55**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.55`, so HACS can track updates reliably.
