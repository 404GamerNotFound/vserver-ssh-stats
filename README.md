...
Current integration version: **1.4.43**.
...
- Current manifest version: **1.4.43**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.43`, so HACS can track updates reliably.
