...
Current integration version: **1.4.46**.
...
- Current manifest version: **1.4.46**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.46`, so HACS can track updates reliably.
