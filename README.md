...
Current integration version: **1.4.54**.
...
- Current manifest version: **1.4.54**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.54`, so HACS can track updates reliably.
