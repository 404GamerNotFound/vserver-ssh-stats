...
Current integration version: **1.4.51**.
...
- Current manifest version: **1.4.51**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.51`, so HACS can track updates reliably.
