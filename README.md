...
Current integration version: **1.4.52**.
...
- Current manifest version: **1.4.52**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.52`, so HACS can track updates reliably.
