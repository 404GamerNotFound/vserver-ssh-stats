...
Current integration version: **1.4.45**.
...
- Current manifest version: **1.4.45**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.45`, so HACS can track updates reliably.
