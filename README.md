...
Current integration version: **1.4.53**.
...
- Current manifest version: **1.4.53**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.53`, so HACS can track updates reliably.
