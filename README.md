...
Current integration version: **1.4.47**.
...
- Current manifest version: **1.4.47**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.47`, so HACS can track updates reliably.
