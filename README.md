...
Current integration version: **1.4.67**.
...
- Current manifest version: **1.4.67**.
...
- Create a matching Git tag and GitHub release, for example `v1.4.67`, so HACS can track updates reliably.
